...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return <p className="text-xs font-semibold tracking-[0.25em] uppercase text-primary mb-3">{children}</p>;
}
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 max-w-2xl mx-auto text-foreground">
              Get In Touch
            </h1>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+17267773595" className="text-foreground hover:text-primary transition-colors">
                        726-777-3595
                      </a>
                    </div>
                  </div>
